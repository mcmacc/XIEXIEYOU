...
async function downloader_jd() {
    if (/require\(['"`]{1}.\/jdCookie.js['"`]{1}\)/.test(remoteContent))
        await download("https://github.com/mcmacc/XIEXIEYOU/raw/main/scripts/jdCookie.js", "./jdCookie.js", "京东Cookies");
    if (remoteContent.indexOf("jdFruitShareCodes") > 0) {
        await download(
            "https://github.com/mcmacc/XIEXIEYOU/raw/main/scripts/jdFruitShareCodes.js",
    ...
    if (remoteContent.indexOf("jdPetShareCodes") > 0) {
        await download(
            "https://github.com/mcmacc/XIEXIEYOU/raw/main/scripts/jdPetShareCodes.js",
            "./jdPetShareCodes.js",
            "京东萌宠"
        );
    }
    if (remoteContent.indexOf("jdPlantBeanShareCodes") > 0) {
        await download(
            "https://github.com/mcmacc/XIEXIEYOU/raw/main/scripts/jdPlantBeanShareCodes.js",
    ...
    if (remoteContent.indexOf("jdSuperMarketShareCodes") > 0)
        await download(
            "https://github.com/mcmacc/XIEXIEYOU/raw/main/scripts/jdSuperMarketShareCodes.js",
            "./jdSuperMarketShareCodes.js",
            "京小超互助码"
        );
    if (remoteContent.indexOf("jdFactoryShareCodes") > 0) {
        await download(
            "https://github.com/mcmacc/XIEXIEYOU/raw/main/scripts/jdFactoryShareCodes.js",
    ...
    if (remoteContent.indexOf("jdDreamFactoryShareCodes") > 0) {
        await download(
            "https://github.com/mcmacc/XIEXIEYOU/raw/main/scripts/jdDreamFactoryShareCodes.js",
    ...
    if (remoteContent.indexOf("jdJxncTokens.js") > 0) {
        await download(
            "https://github.com/mcmacc/XIEXIEYOU/raw/main/scripts/jdJxncTokens.js",
            "./jdJxncTokens.js",
            "京喜农场token"
        );
    }
    if (remoteContent.indexOf("new Env('京喜农场')") > 0) {
        ...
        await download(
            "https://github.com/mcmacc/XIEXIEYOU/raw/main/scripts/jdJxncShareCodes.js",
            "./jdJxncShareCodes.js",
            "京喜农场分享码"
        );
        await download(
            "https://github.com/mcmacc/XIEXIEYOU/raw/main/scripts/USER_AGENTS.js",
            "./USER_AGENTS.js",
            "USER_AGENTS"
        );
    }
...
async function downloader_notify() {
    await download("https://github.com/mcmacc/XIEXIEYOU/raw/main/scripts/sendNotify.js", "./sendNotify.js", "统一通知");
}

async function downloader_user_agents() {
    await download("https://github.com/mcmacc/XIEXIEYOU/raw/main/scripts/USER_AGENTS.js", "./USER_AGENTS.js", "云端UA");
}
