...
on:
    workflow_dispatch:
    schedule:
        - cron: "0 0,9,11,13,15,17,19,20,21,23 * * *"
    watch:
        types: [started]
    repository_dispatch:
        types: jd_live_redrain_offical
        ...
        steps:
            ...
            - name: "运行 【官方号直播红包雨】"
              ...
              env:
                  ...
                  MONEY_TREE_SELL_FRUIT: ${{ github.event.client_payload.MONEY_TREE_SELL_FRUIT || secrets.MONEY_TREE_SELL_FRUIT }}
                  SYNCURL: https://raw.githubusercontent.com/mcmacc/jd_scripts/master/jd_live_redrain_offical.js
